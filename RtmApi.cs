...
namespace SlackNet.WebApi
{
    public interface IRtmApi
    {
        ...
        Task<ConnectResponse> SocketConnect(bool manualPresenceSubscription = false, bool batchPresenceAware = false, CancellationToken? cancellationToken = null);
    ...
    public class RtmApi : IRtmApi
    {
        ...
        /// <param name="batchPresenceAware">Group presence change notices in <see cref="PresenceChange"/> events when possible.</param>
        /// <param name="cancellationToken"></param>
        public Task<ConnectResponse> Connect(bool manualPresenceSubscription = false, bool batchPresenceAware = false,
            CancellationToken? cancellationToken = null)
        {
            return _client.Get<ConnectResponse>("rtm.connect", new Args { { "presence_sub", manualPresenceSubscription }, { "batch_presence_aware", batchPresenceAware } }, cancellationToken);
        }

       
        public Task<ConnectResponse> SocketConnect(bool manualPresenceSubscription = false,
            bool batchPresenceAware = false, CancellationToken? cancellationToken = null)
        {
            return _client.Post<ConnectResponse>("apps.connections.open", new Args { { "presence_sub", manualPresenceSubscription }, { "batch_presence_aware", batchPresenceAware } }, cancellationToken);
        }
