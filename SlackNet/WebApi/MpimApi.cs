...
namespace SlackNet.WebApi
{
    public interface IMpimApi
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"></param>
        Task<IReadOnlyList<Channel>> List(CancellationToken? cancellationToken = null);
        ...
        /// <param name="cancellationToken"></param>
        Task<Channel> Open(IEnumerable<string> userIds, CancellationToken? cancellationToken = null);
