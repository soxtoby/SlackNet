...
namespace SlackNet.WebApi
{
    ...
    public interface IImApi
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"></param>
        Task<IReadOnlyList<Im>> List(CancellationToken? cancellationToken = null);
        ...
        /// <param name="cancellationToken"></param>
        Task<ImResponse> Open(string userId, bool returnIm = false, CancellationToken? cancellationToken = null);
