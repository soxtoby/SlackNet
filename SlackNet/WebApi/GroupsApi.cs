...
namespace SlackNet.WebApi
{
    public interface IGroupsApi
    {
        ...
        /// <param name="cancellationToken"></param>
        Task<Channel> CreateChild(string channelId, CancellationToken? cancellationToken = null);
        ...
        /// <param name="cancellationToken"></param>
        Task<ChannelHistoryResponse> History(
            string channelId,
        ...
        /// call the <see cref="GroupsApi.CreateChild"/> method before inviting.
        /// </summary>
        /// <param name="channelId">Private channel to invite user to.</param>
        /// <param name="userId">User to invite.</param>
        /// <param name="cancellationToken"></param>
        Task<Channel> Invite(string channelId, string userId, CancellationToken? cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task Kick(string channelId, string userId, CancellationToken? cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        Task<IReadOnlyList<Channel>> List(bool excludeArchived = false, CancellationToken? cancellationToken = null);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task Open(string channelId, CancellationToken? cancellationToken = null);
