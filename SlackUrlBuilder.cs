...
namespace SlackNet
{
    public interface ISlackUrlBuilder
    {
        ...
        string Url(string apiMethod, Args args, bool socketmode);
    }
    ...
    class SlackUrlBuilder : ISlackUrlBuilder
    {
        ...
        public string Url(string apiMethod, Args args, bool socketmode)
        {
            return $"https://api.slack.com/api/{apiMethod}";
        }
